...
**v0 — Notes widget** (this build): a small, frameless, always-on-top window that
floats over whatever you're reading. Type a note, hit Enter, and it appends a
timestamped bullet to today's `Daily/YYYY-MM-DD.md` under `## Quick Notes` — so
Claude picks it up as vault content and manages it from there.

Planned next: the 3-panel **Tasks / Reading / Projects** dashboard (see the
vault note `Projects/Second-Brain-Task-App.md`).
